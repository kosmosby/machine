...
define('ACYM_UPDATEURL', 'https://www.acyba.com/index.php?option=com_updateme&ctrl=update&task=');
...
function acym_modal($button, $data, $id = null, $attributesModal = '', $attributesButton = '', $isButton = true)
{
    ...
    $modal .= '<div class="reveal" data-reveal-larger id="'.$id.'" '.$attributesModal.' data-reveal>';
    $modal .= $data;
...
function acym_modal_pagination_lists_import($button, $class, $textButtonRight, $id = null, $attributes = '', $classButton = 'acym__users__import__generic__import__button')
{
    if (empty($id)) {
    ...
    $data = '
            ...
            <div class="cell grid-x">
              ...
              <div class="cell grid-margin-x large-up-2 small-up-1" id="modal__pagination__listing__button-submit">   
                <button class="cell button '.$classButton.'" id="lists">'.$textButtonRight.'</button>
              </div>';
