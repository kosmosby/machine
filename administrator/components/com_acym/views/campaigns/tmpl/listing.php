	...
	<div id="acym__campaigns" class="acym__content">
        ...
        <?php } else { ?>
			<div class="grid-x grid-margin-x">
				...
				<div class="xxlarge-2 xlarge-1 hide-for-medium-only hide-for-small-only cell"></div>
				<div class="medium-2 cell">
					<button data-task="duplicate" type="button" class="button button-secondary acy_button_submit acym__campaign__duplicate cell"><?php echo acym_translation('ACYM_DUPLIACTE') ?></button>
				</div>
